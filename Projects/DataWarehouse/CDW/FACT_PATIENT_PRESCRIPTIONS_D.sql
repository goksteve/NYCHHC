DROP TABLE fact_patient_prescriptions_d CASCADE CONSTRAINTS;

CREATE TABLE fact_patient_prescriptions_d
(
...
CREATE BITMAP INDEX bmi_patient_prescriptions_d
 ON fact_patient_prescriptions_d(drug_description)
 LOCAL;

CREATE OR REPLACE PUBLIC SYNONYM fact_patient_prescriptions_d FOR fact_patient_prescriptions_d;
GRANT SELECT ON fact_patient_prescriptions_d TO PUBLIC;