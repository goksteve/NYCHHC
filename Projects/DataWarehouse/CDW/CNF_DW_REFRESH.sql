...
INSERT INTO cnf_dw_refresh VALUES(3120, 'REPLACE /*+ PARALLEL(32) APPEND */', 'FACT_RESULTS', 'V_FACT_RESULTS_FULL', NULL, 'WHERE network=''QHN''', NULL, NULL);
INSERT INTO cnf_dw_refresh VALUES(3130, 'REPLACE /*+ PARALLEL(32) APPEND */', 'FACT_RESULTS', 'V_FACT_RESULTS_FULL', NULL, 'WHERE network=''SMN''', NULL, NULL);
INSERT INTO cnf_dw_refresh VALUES(3140, 'REPLACE /*+ PARALLEL(32) APPEND */', 'FACT_RESULTS', 'V_FACT_RESULTS_FULL', NULL, 'WHERE network=''NBX''', NULL, NULL);
INSERT INTO cnf_dw_refresh VALUES(3150, 'REPLACE /*+ PARALLEL(32) APPEND */', 'FACT_RESULTS', 'V_FACT_RESULTS_FULL', NULL, 'WHERE network IN (''GP2'',''SBN'')', NULL, NULL);
INSERT INTO cnf_dw_refresh VALUES(3160, 'REPLACE /*+ PARALLEL(32) APPEND */', 'FACT_RESULTS', 'V_FACT_RESULTS_FULL', NULL, 'WHERE network IN (''CBN'',''NBN'')', NULL, NULL);
