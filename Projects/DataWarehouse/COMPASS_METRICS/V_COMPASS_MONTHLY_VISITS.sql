...
SELECT --+ parallel(32)
 ...
 -- 29-Jun-2018, Gk: Added Tobbaco, PNA, Flu fields
  ...
  a.visit_id,
  a.patient_id,
  decode(a.facility,'Coler Rehabilitation and Nursing Care Center','Coler Memorial Hospital',a.facility) AS facility,
  a.admission_dt_key,
  a.admission_dt,
  a.discharge_dt,
  a.visit_type,
...
SELECT 
  ...
  decode(b.facility,'Coler Rehabilitation and Nursing Care Center','Coler Memorial Hospital',b.facility) AS facility,
  b.admission_dt_key,
  b.admission_dt,
  b.discharge_dt,
  b.visit_type,
