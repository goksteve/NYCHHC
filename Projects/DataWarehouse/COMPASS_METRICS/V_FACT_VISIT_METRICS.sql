...
CASE WHEN  p.bh_f_onset_dt    >= v.admission_dt THEN 1 ELSE 0  END AS bh_ind,
CASE WHEN breast_cancer_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS     breast_cancer_ind,
CASE WHEN diabetes_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS     diabetes_ind,
CASE WHEN heart_failure_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS    heart_failure_ind,
CASE WHEN schizophrenia_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS      schizophrenia_ind,
CASE WHEN bipolar_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS            bipolar_ind,
CASE WHEN htn_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS    hypertension_ind,
CASE WHEN kidney_dz_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS  kidney_diseases_ind,
CASE WHEN smoker_f_onset_dt>= v.admission_dt THEN 1 ELSE 0  END AS    smoker_ind,
CASE WHEN pregnancy_l_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS    pregnancy_ind,
CASE WHEN pregnancy_l_onset_dt >= v.admission_dt THEN p.pregnancy_l_onset_dt ELSE NULL  END AS pregnancy_onset_dt,
CASE WHEN flu_vaccine_l_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS    flu_vaccine_ind,
CASE WHEN flu_vaccine_l_onset_dt >= v.admission_dt THEN flu_vaccine_l_onset_dt  ELSE NULL END AS flu_vaccine_onset_dt,
CASE WHEN pna_vaccine_l_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS    pna_vaccine_ind,
CASE WHEN pna_vaccine_l_onset_dt >= v.admission_dt THEN pna_vaccine_l_onset_dt ELSE NULL  END AS     pna_vaccine_onset_dt,
CASE WHEN bronchitis_l_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS    bronchitis_ind,
CASE WHEN bronchitis_l_onset_dt >= v.admission_dt THEN bronchitis_l_onset_dt ELSE NULL  END AS     bronchitis_onset_dt,
CASE WHEN tabacco_diag_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS     tabacco_scr_diag_ind,
CASE WHEN tabacco_diag_f_onset_dt >= v.admission_dt THEN tabacco_diag_f_onset_dt  ELSE NULL  END AS     tabacco_scr_diag_onset_dt,
CASE WHEN major_depression_f_onset_dt >= v.admission_dt THEN 1 ELSE 0  END AS    major_depression_ind,
  q.criterion_id,
  q.result_value,
  CASE
