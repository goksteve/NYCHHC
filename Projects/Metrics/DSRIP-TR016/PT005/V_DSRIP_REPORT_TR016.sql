...
--    date '2018-04-01' report_dt,
--    ADD_MONTHS(date '2018-04-01', -12) year_back_dt
    FROM dual
  ),
  prescriptions AS
  (
    ...
    LEFT JOIN cdw.ref_drug_names dnm ON dnm.drug_name = pr.drug_name 
    LEFT JOIN cdw.ref_drug_descriptions dscr ON dscr.drug_description = pr.drug_description 
