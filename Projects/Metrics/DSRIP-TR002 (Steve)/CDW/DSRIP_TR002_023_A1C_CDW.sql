...
(
 ...
 a1c_final_orig_value   VARCHAR2(1023 BYTE) NULL,
 a1c_final_calc_value   VARCHAR2(1023 BYTE) NULL,
 dsrip_report           CHAR(15 BYTE) NULL,
 report_dt              DATE NULL,
 load_dt                DATE NULL
)
COMPRESS BASIC
...
GRANT SELECT ON dsrip_tr_002_023_hba1c TO PUBLIC;