DROP VIEW v_dsrip_report_tr002_023_cdw;

CREATE OR REPLACE FORCE VIEW v_dsrip_report_tr002_023_cdw AS
 SELECT
 *
 FROM
 (WITH report_dates AS
   ...
   SELECT --+ parallel(32)
    ...
    TO_NUMBER(TO_CHAR(pp.admission_dt,'YYYYMMDD'))  AS admission_dt_key,
    pp.facility_key,
