DROP PROCEDURE sp_refresh_tr043_report;

CREATE OR REPLACE PROCEDURE PREPARE_DSRIP_REPORT_TR043(p_report_month IN DATE DEFAULT NULL)
AS
  d_report_mon  DATE;
  n_cnt         PLS_INTEGER := 0;
BEGIN

 xl.open_log('PREPARE DSRIP_TR043_REPORT', SYS_CONTEXT('USERENV','OS_USER')||': Generating TR043 reports', TRUE);
