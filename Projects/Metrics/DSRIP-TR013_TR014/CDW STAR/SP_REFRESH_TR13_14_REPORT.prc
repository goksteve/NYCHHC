CREATE OR REPLACE PROCEDURE sp_refresh_tr13_14_report(p_report_month IN DATE DEFAULT NULL) AS
  d_report_mon  DATE;
  n_cnt         PLS_INTEGER;
BEGIN
  ...
  DELETE FROM dsrip_report_tr013_14 WHERE report_period_start_dt = d_report_mon;
  ...
  (
     ...
     p_tgt => 'DSRIP_REPORT_TR013_14',
     p_src => 'V_DSRIP_REPORT_TR013_14',
     p_commit_at => -1
  );
