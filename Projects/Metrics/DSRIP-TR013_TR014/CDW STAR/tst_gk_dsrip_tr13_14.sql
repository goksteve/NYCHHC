CREATE TABLE tst_gk_dsrip_tr13_14
NOLOGGING
COMPRESS BASIC
PARALLEL 32
AS
...
--        dt.msrmnt_yr_end_dt,
    ...
    JOIN fact_visits /*ud_master.visit*/ vst
      ON vst.admission_dt BETWEEN dt.begin_dt AND dt.end_dt --AND vst.patient_id = 2411599 AND vst.network = 'CBN'
  ...
  (
    ...
    JOIN fact_visits vst
      ON vst.patient_id = vst_lkp.patient_id AND vst.network = vst_lkp.network
