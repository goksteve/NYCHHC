--DROP PROCEDURE SP_REFRESH_TR010_REPORT;
--GRANT EXECUTE ON PT005.PREPARE_DSRIP_REPORT_TR010 TO CDW;


CREATE OR REPLACE PROCEDURE PREPARE_DSRIP_REPORT_TR010(p_report_month IN DATE DEFAULT NULL)  
AS
  d_report_mon  DATE;
  n_cnt         PLS_INTEGER;
BEGIN
