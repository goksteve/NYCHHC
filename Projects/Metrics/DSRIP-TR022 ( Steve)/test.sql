--CREATE TABLE dsrip_tr_022_diab_screen_cdw AS  SELECT * FROM v_dsrip_tr_022_diab_screen_cdw
...
SELECT /*+  parallele (32 */
 ...
 pat.visit_id,
 pat.visit_number,
 pat.visit_facility_id,
 pat.visit_facility_name,
 pat.patient_id,
 pat.pat_lname,
 pat.pat_fname,
 pat.mrn,
 ...
 'DSRIP_TR022_COMPREHENSIVE_DIABETES SCREENING-All Three Tests' AS dsrip_report,
 pat.report_dt,
