EXEC dbm.drop_tables('DSRIP_TR_022_DIAB_SCREEN_CDW');

CREATE TABLE dsrip_tr_022_diab_screen_cdw
(
...
CREATE INDEX idx_dsrip_tr_022_diab_scrn_cdw
 ON dsrip_tr_022_diab_screen_cdw(report_dt)
 LOCAL (
  PARTITION cbn,
  PARTITION gp1,
  PARTITION gp2,
...
CREATE UNIQUE INDEX pk_dsrip_tr_022_diab_scrn_cdw
 ON dsrip_tr_022_diab_screen_cdw(
  network,
  patient_id,
  visit_id,
  report_dt)
...
ALTER TABLE dsrip_tr_022_diab_screen_cdw ADD (
...
GRANT SELECT ON dsrip_tr_022_diab_screen_cdw TO PUBLIC;