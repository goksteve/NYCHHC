--CREATE OR REPLACE VIEW V_DSRIP_REPORT_TR046_TR010
CREATE TABLE DSRIP_REPORT_TR046_TR010
NOLOGGING
PARALLEL 32
AS
WITH 
  ...
  (
    SELECT --+ materialize
      ...
      ADD_MONTHS(NVL(TO_DATE(SYS_CONTEXT('USERENV','CLIENT_IDENTIFIER')), TRUNC(SYSDATE, 'MONTH')), -12) begin_dt
    FROM dual
  ),
