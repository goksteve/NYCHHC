CREATE OR REPLACE VIEW v_dsrip_tr017_diab_mon_epic AS
 WITH max_prt_dt AS
       (SELECT
         MAX(NVL(report_dt, TO_DATE('01/01/2018', 'MM/DD.YYYY'))) rpt_dt
        FROM
         dsrip_tr017_diab_mon_epic)
 SELECT
  DISTINCT parent_location_name,
           location_id,
           location_name,
           mrn_empi,
           location_mrn,
