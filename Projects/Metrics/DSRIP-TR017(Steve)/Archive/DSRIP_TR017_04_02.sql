...
FROM
 res_gluc_ldl res
    LEFT JOIN tmp_pcp_bh lst ON  res.network = lst.network AND res.patient_id = lst.patient_id and  lst.visit_id  = res.visit_id
)
 PIVOT
...
CASE  WHEN  res.a1c_final_orig_value IS NOT NULL AND res.ldl_final_orig_value IS NOT NULL THEN 1 END comb_ind ,
CASE  WHEN  res.a1c_final_orig_value IS NOT NULL AND res.ldl_final_orig_value IS  NULL THEN 1 END gluc_ind ,
CASE  WHEN  res.a1c_final_orig_value IS  NULL AND res.ldl_final_orig_value IS NOT NULL THEN 1 END ldl_ind ,
res.visit_facility_id,
res.visit_facility_name,
res.patient_id,
...
pp.pcp_provider_name as pcp,            
 ...
 res.a1c_final_orig_value,
 res.a1c_final_calc_value,
 res.ldl_final_orig_value,
 res.ldl_final_calc_value,
 res.report_dt,
 res.load_dt
FROM tmp_res res
