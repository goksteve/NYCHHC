exec dbm.drop_tables('DSRIP_REPORT_PQI90_1_3_14');

CREATE TABLE dsrip_report_pqi90_1_3_14
(
  ...
  diab_shortterm_complication  VARCHAR2(2000),
  diab_longterm_complication  VARCHAR2(2000),
  uncontrolled_diab_diagnoses  VARCHAR2(2000),
  exclusion_diagnoses     VARCHAR2(2000),
  CONSTRAINT dsrip_rpt_pqi90_1_3_14_PK PRIMARY KEY(report_period_start_dt, network, visit_id) USING INDEX COMPRESS
) COMPRESS BASIC;
