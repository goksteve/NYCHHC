...
DROP TABLE stg_fact_patient_prescrip_1;

CREATE TABLE stg_fact_patient_prescrip_1
NOLOGGING
...
(
 ...
 SELECT /*+ PARALLEl (32) */
    ...
    CASE WHEN rx.misc_name IS NULL THEN dn.derived_product_name ELSE rx.derived_product_name END  AS derived_product_name,
    'QCPR' AS SOURCE,
