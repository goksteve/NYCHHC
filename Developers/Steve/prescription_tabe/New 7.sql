...
(
  ...
  LEFT JOIN prescription_status rx_status ON rx_status.network = rx.netwoek and rx_status.prescription_status_id = rx.prescription_status_id
  LEFT JOIN prescription_type rx_type ON  rx_type.network = rx.networkrx_type.prescription_type_id = rx.prescription_type_id
